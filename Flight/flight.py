...
def insert_data(flight_data):
    ...
    try:
        ...
        for flight in flight_data:
            ...
            formatted_departure_time = departure_datetime.strftime("%Y-%m-%d %H:%M:%S")
            ...
            values = (flight_number, formatted_departure_time, departure_date, arrival_place, arrival_date, formatted_arrival_time, aircraft_type, airline, estimated_time)
...
def search_flight(airport_name, date_str):
    # Get the start time as the current time
    current_time = datetime.now()
    start_time = current_time.strftime("%H:%M:%S")

    # Set the end time as 23:59:59
    end_time = "23:59:59"
